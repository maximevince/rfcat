...
class RadioConfig(vstruct.VStruct):
    def __init__(self):
        ...
        self.iocfg2     = v_uint8()       #0x00
        self.iocfg1     = v_uint8()       #0x01
        self.iocfg0     = v_uint8()       #0x02
        self.fifothr    = v_uint8()       #0x03
        self.sync1      = v_uint8()       #0x04
        self.sync0      = v_uint8()       #0x05
        self.pktlen     = v_uint8()       #0x06
        self.pktctrl1   = v_uint8()       #0x07
        self.pktctrl0   = v_uint8()       #0x08
        self.addr       = v_uint8()       #0x09
        self.channr     = v_uint8()       #0x0a
        self.fsctrl1    = v_uint8()       #0x0b
        self.fsctrl0    = v_uint8()       #0x0c
        self.freq2      = v_uint8()       #0x0d
        self.freq1      = v_uint8()       #0x0e
        self.freq0      = v_uint8()       #0x0f
        self.mdmcfg4    = v_uint8()       #0x10
        self.mdmcfg3    = v_uint8()       #0x11
        self.mdmcfg2    = v_uint8()       #0x12
        self.mdmcfg1    = v_uint8()       #0x13
        self.mdmcfg0    = v_uint8()       #0x14
        self.deviatn    = v_uint8()       #0x15
        self.mcsm2      = v_uint8()       #0x16
        self.mcsm1      = v_uint8()       #0x17
        self.mcsm0      = v_uint8()       #0x18
        self.foccfg     = v_uint8()       #0x19
        self.bscfg      = v_uint8()       #0x1a
        self.agcctrl2   = v_uint8()       #0x1b
        self.agcctrl1   = v_uint8()       #0x1c
        self.agcctrl0   = v_uint8()       #0x1d
        self.worevt1    = v_uint8()       #0x1e
        self.worevt0    = v_uint8()       #0x1f
        self.worctrl    = v_uint8()       #0x20
        self.frend1     = v_uint8()       #0x21
        self.frend0     = v_uint8()       #0x22
        self.fscal3     = v_uint8()       #0x23
        self.fscal2     = v_uint8()       #0x24
        self.fscal1     = v_uint8()       #0x25
        self.fscal0     = v_uint8()       #0x26
        self.rcctrl1    = v_uint8()       #0x27
        self.rcctrl2    = v_uint8()       #0x28
        self.fstest     = v_uint8()       #0x29
        self.ptest      = v_uint8()       #0x2a
        self.agctest    = v_uint8()       #0x2b
        self.test2      = v_uint8()       #0x2c
        self.test1      = v_uint8()       #0x2d
        self.test0      = v_uint8()       #0x2e
        self.dummy      = v_uint8()       #0x2f
        self.partnum    = v_uint8()       #0x30
        self.chipid     = v_uint8()       #0x31
        self.freqest    = v_uint8()       #0x32
        self.lqi        = v_uint8()       #0x33
        self.rssi       = v_uint8()       #0x34
        self.marcstate  = v_uint8()       #0x35
        self.wortime1   = v_uint8()       #0x36
        self.wortime0   = v_uint8()       #0x37
        self.pkstatus   = v_uint8()       #0x38
        self.vco_vc_dac = v_uint8()       #0x39
        self.txbytes    = v_uint8()       #0x3a
        self.rxbytes    = v_uint8()       #0x3b
...
FREQ1                          = 0x0E
FREQ2                          = 0x0D
FREQEST                        = 0x32   # needs burst read! (read=+80 burst read:+80+40=+C0)
FSCAL0                         = 0x26
FSCAL1                         = 0x25
FSCAL2                         = 0x24
FSCAL2_FSCAL2                  = 0x1F
...
LED_MODE_OFF                   = 0x00
LED_MODE_ON                    = 0x01
LQI                            = 0x33   # burst read + C0!
MARCSTATE                      = 0x35   # burst read + C0!
...
#MDMCTRL0H                      = 0xDF02 # unavailable in cc1101
MEMCTR                         = 0xC7
MEMCTR_CACHD                   = 0x02
MEMCTR_PREFD                   = 0x01
MODE                           = 128
...
WOREVT0                        = 0x1F
WOREVT1                        = 0x1E
#WORIRQ                         = 0xA1 # Unavailable on CC1101
