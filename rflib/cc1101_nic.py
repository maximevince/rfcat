...
class NICxx11(SPIDongle):
    ...
    def __init__(self, idx=0, debug=True, copyDongle=None, RfMode=RFST_SRX):
        SPIDongle.__init__(self, idx, debug, copyDongle, RfMode)
